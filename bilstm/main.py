...
trn, vld = TabularDataset.splits(path="data",
...
# TEXT.build_vocab(trn, vld, max_size=200, vectors=None)
...
#                                              # tell the bucketIterator how to group the sequences
#                                              sort_within_batch=False,
#                                              repeat=False)  # we want to wrap this Iterator layer
# test_iter = Iterator(tst, batch_size=3, device='cpu', sort=False, sort_within_batch=False, repeat=False)
#
